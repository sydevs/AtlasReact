...
import { RegistrationButton } from '@/components/organisms/event-registration'
import { EventImages } from '@/components/molecules/event-images'
import { ShareButton } from '@/components/molecules/event-share'
import {
  EventContactDetails,
